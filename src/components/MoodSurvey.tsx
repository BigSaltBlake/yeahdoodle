...
const QUESTIONS = [
  ...
  },
  {
    ...
    subtitle: '',
    options: [
      { label: 'Free–$25', desc: 'Free fun is real fun', emoji: '�f', quality: 'Good' },
      { label: '$25–$75', desc: 'Happy to spend on a good night', emoji: '�k', quality: 'Better' },
          ...
          >
            ...
            <div className="flex gap-1.5 mb-5">
              {QUESTIONS.map((_, i) => (
                <div
                  key={i}
                  className="h-q''' rounded-full transition-all duration-300"

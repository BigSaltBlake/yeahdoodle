...
function formatPrice(
  ...
  if (priceMax && priceMax > priceMin) return `$${Math.round(priceMin)}ÃÂ¢ÃÂÃÂ$${Math.round(priceMax)}`
...
Return ONLY a valid JSON array ÃÂ¢ÃÂÃÂ no other text, no markdown, no explanation:
[

...
// Fire-and-forget crawl to warm geohash cache on first GPS fix
useEffect(() => {
if (userLat == null || userLng == null || crawlTriggeredRef.current) return
crawlTriggeredRef.current = true
fetch('/api/crawl', {
method: 'POST',
headers: { 'Content-Type': 'application/json' },
body: JSON.stringify({ lat: userLat, lng: userLng, city: activeCity }),
}).catch(() => {/* fire and forget */})
}, [userLat, userLng, activeCity]) // eslint-disable-line react-hooks/exhaustive-deps
